  ...
  fetch(drinkUrl)
      ...
      .then((data) => {
          ...
          const textContent = `
              <div class="drink">
                  <h1>${drinkTitle}</h1>
                  <img src="${imagesrc}" alt="cocktail image">
          ...
          drinkContainerEl.innerHTML += textContent;
          localStorage.setItem('pastResultsCocktail', JSON.stringify(drinkData.idDrink));
      });
}
